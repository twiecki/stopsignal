...
Go_like = stochastic_from_dist(name="Ex-Gauss GoRT",
                               logp=cython_Go)

SRRT_like = stochastic_from_dist(name="CensoredEx-Gauss SRRT",
                                 logp=cython_SRRT)

Inhibitions_like = stochastic_from_dist(name="CensoredEx-Gauss Inhibittions",
